...
public ResultVO<OrderDTO> updateOrderPrice(
        @PathVariable Integer orderId,
        @RequestParam("final_price") BigDecimal finalPrice,
        @RequestParam(value = "coupon_id", required = false) Integer couponId) {
    OrderDTO updatedOrder = orderService.updateOrderPrice(orderId, finalPrice, couponId);
    return ResultVO.buildSuccess(updatedOrder);
}
